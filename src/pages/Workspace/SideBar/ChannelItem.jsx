            ...
            >
               {({ isActive }) => (
                  <Button
                     variant="ghost"
                     className={
                        "w-full justify-start group items-center " +
                        (isActive ? "bg-muted" : "")
                     }
                  >
                     <Hash className="w-5 h-5 mr-2 stroke-gray-500" />
                     <span className="text-gray-500 text-md text-ellipsis truncate w-full text-left">
                        {name}
                     </span>
                     <TooltipProvider
                        delayDuration={10}
                     ...
                     >
                        <Tooltip>
                           <TooltipTrigger asChild>
                              <Link
                                 to={`/Workspace/${workspaceId}/${cid}/ChannelSetting`}
                              >
                                 <Settings
                                    className="w-5 h-5 stroke-gray-900 ml-auto invisible group-hover:visible"
                                    strokeWidth={2}
                                 />
                              </Link>
                           </TooltipTrigger>
