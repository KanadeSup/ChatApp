...
import { getUnroleMember, getMemberByRole } from "/api/workspace";
      ...
      <Form
         ...
         onSubmit={async (e) => {
            ...
            Object.keys(arePermissionEnable).forEach((key) => {
               if (arePermissionEnable[key]) enableList.push({ id: key });
            });
            const roleData = {
               name: name,
            ...
            // update
            const res = await updateWorkspaceRole(
               workspaceId,
               roleId,
               roleData,
            );
                        ...
                        <div className="" key={permission.id}>
                           <div className="flex justify-between items-center">
                              ...
                              <Switch
                                 name="permissiond"
                                 checked={
                                    arePermissionEnable[permission.id]
                                 }
