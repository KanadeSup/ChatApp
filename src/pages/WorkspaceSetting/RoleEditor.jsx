...
import { getWorkspacePermissions, createWorkspaceRole, getWorkspaceRoleById } from "/api"
   ...
   useEffect(()=>{
      async function fetchData() {
         ...
         data.permissions.map(p=> {
            if(p.isEnabled) enablePermissions.push(p.id)
         })
                           ...
                           <div className="" key={permission.id}>
                              <div className="flex justify-between items-center">
                                 ...
                                 <Switch name="permissiond" 
                                    checked={enablePermissions.includes(permission.id)}
                                    onCheckedChange={(checked) => {
                                       if(checked) enablePermissions.push(permission.id)
                                       else enablePermissions.pop(enablePermissions.indexOf(permission.id))
                                       setEnablePermissions([...enablePermissions])
                                    }}
                                 />
                              </div>
