...
export default function FileCard({
  ...
  return (
    <div
      ...
      className="relative flex items-center px-4 py-3 select-none min-w-[333px] 2xl:min-w-[360px] max-w-fit bg-white cursor-pointer border border-slate-300 rounded-xl"
    >
